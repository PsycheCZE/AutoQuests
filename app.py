...
def execute_ahk_actions(text, remove_f=False, type_34=False):
    ...
    if type_34:
        ...
        ahk.mouse_move(414, 457, speed=5)
        time.sleep(0.1)
        ahk.click()
        time.sleep(0.5)

        ahk.mouse_move(684, 513, speed=5)
        for _ in range(1000):
            ahk.click()
            time.sleep(0.001) 
        time.sleep(0.5)
    ...
    if not type_34:
        ...
        ahk.mouse_move(504, 381, speed=5)
        time.sleep(0.1)
        ahk.click()
        time.sleep(1)

        ahk.mouse_move(947, 746, speed=5)
        time.sleep(0.1)
        ahk.click()
        time.sleep(1)

    if type_34:
        ahk.mouse_move(410, 394, speed=10)
        time.sleep(0.1)
        ahk.click()
        time.sleep(0.5)

    ahk.mouse_move(908, 126, speed=10)
    time.sleep(0.5)
    if not remove_f:
        ahk.key_press('F')
...
def toggle_script():
    if button.config('text')[-1] == 'Start':
        ...
        stop_thread.clear()
        Thread(target=check_api_and_run).start()
    else:
